...
async def scan_scale(user_id: uuid.UUID = Query(...)):
    ...
    - Pulso app at C:/src/pulso/pulso-app
    - scripts/scale_profile.json configured
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=504, detail="Scale scan timed out (45s). Is the scale active?"
        )
