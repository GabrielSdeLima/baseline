...
async def _seed_lookups(session: AsyncSession) -> None:
    ...
    session.add_all(
        [
            ...
            # HC900 scale — full body composition (migration e4f5a6b7c8d9)
            mt(slug="impedance_adc", name="Bioimpedance (ADC)",
               category="body_composition", default_unit="adc", value_precision=0),
            mt(slug="bmi", name="Body Mass Index",
               category="body_composition", default_unit="kg/m²", value_precision=1),
            mt(slug="bmr", name="Basal Metabolic Rate",
               category="body_composition", default_unit="kcal", value_precision=0),
            mt(slug="fat_free_mass_kg", name="Fat-Free Mass",
               category="body_composition", default_unit="kg", value_precision=1),
            mt(slug="fat_mass_kg", name="Fat Mass",
               category="body_composition", default_unit="kg", value_precision=1),
            mt(slug="skeletal_muscle_mass_kg", name="Skeletal Muscle Mass",
               category="body_composition", default_unit="kg", value_precision=1),
            mt(slug="skeletal_muscle_pct", name="Skeletal Muscle %",
               category="body_composition", default_unit="%", value_precision=1),
            mt(slug="muscle_mass_kg", name="Total Muscle Mass",
               category="body_composition", default_unit="kg", value_precision=1),
            mt(slug="muscle_pct", name="Total Muscle %",
               category="body_composition", default_unit="%", value_precision=1),
            mt(slug="water_mass_kg", name="Total Body Water",
               category="body_composition", default_unit="kg", value_precision=1),
            mt(slug="water_pct", name="Body Water %",
               category="body_composition", default_unit="%", value_precision=1),
            mt(slug="protein_mass_kg", name="Protein Mass",
               category="body_composition", default_unit="kg", value_precision=2),
            mt(slug="protein_pct", name="Protein %",
               category="body_composition", default_unit="%", value_precision=1),
            mt(slug="bone_mass_kg", name="Bone Mineral Mass",
               category="body_composition", default_unit="kg", value_precision=2),
            mt(slug="ffmi", name="Fat-Free Mass Index",
               category="body_composition", default_unit="kg/m²", value_precision=1),
            mt(slug="fmi", name="Fat Mass Index",
               category="body_composition", default_unit="kg/m²", value_precision=1),
        ]
    )
